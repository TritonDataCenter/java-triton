...
public class CloudApiResponseException extends CloudApiIOException {
    ...
    /**
     * Constructs an {@code CloudApiResponseException} with an error message
     ...
     */
    public CloudApiResponseException(final String operationName,
     ...
     * @param requestId the request id associated with the request
     */
    public CloudApiResponseException(final String message,
     ...
     * @param requestId the request id associated with the request
     */
    public CloudApiResponseException(final Throwable cause,
                                     final String operationName,
                                     final StatusLine statusLine,
                                     final ErrorDetail errorDetail,
                                     final String requestId) {
    ...
    protected String buildErrorDetailMessage() {
        final String format = "CloudAPI Error on %s (HTTP %d - %s) [%s]: %s";
